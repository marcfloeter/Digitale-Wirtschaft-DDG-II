...
# Fazit
Unsere Forschungsfrage lässt sich in beiden Fällen, sowohl bei den Kunden als auch bei den Gastronomen mit einem **NEIN** beantworten. Die Forschung an diesem Thema lieferte uns trotzdem wichtige Daten, Einblicke und Eindrücke über potenzielle Entwicklungen

Unsere Auswertungen mithilfe der linearen Regression zeigen unter anderem, dass es mit dem Beginn der Coronakrise durchaus zu Veränderungen gekommen ist. Diese erfolgen allerdings in solch einem geringen Umfang, dass deren Auswirkungen nicht signifikant sind.
