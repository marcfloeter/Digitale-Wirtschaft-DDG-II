...
Auch aus wirtschaftlicher Perspektive ist das Thema relevant. Die Erforschung dieser Frage zeigt, ob eine Digitalisierung aufgrund der Pandemie als nötig und gewinnbringend eingeschätzt wurde und wie oder ob sich dieser Wirtschaftsbereich digital angepasst hat. Daraus lassen sich nützliche Informationen ziehen, die für die Bewältigung ähnlich kritischer Situationen genutzt werden können.
Nicht zuletzt hat die Befragung der Bevölkerung zu einem alltäglichen Thema in einer solch außergewöhnlichen Zeit auch einen historisch dokumentierenden Wert.

## Hergang der Themenwahl

Diese Forschungsfrage ist vom übergeordneten Thema "Digitale Wirtschaft" abgeleitet. Uns auf den Bereich der Gastronomie zu spezialiseren hatte haupsächlich den Grund, dass es ein greifbares und alltägliches Thema ist, zu dem im Rahmen unserer Möglichkeiten dieses Kurses auch eine angemessene Menge an Daten ermittelt werden kann. Weitere Gründe waren selbstverständlich unsere eigene Neugier zu diesem Thema und die zuvor genannte generelle Relevanz dieses Themas für verschiedenste Bereiche.
...
## Detailliertere Beschreibung der Fragebögen
Beide Bögen bestehen im ersten Abschnitt aus Fragen zu demographischen Angaben des Studienteilnehmers, danach aus jeweils einem Teil mit Grundfragen zum Thema Lieferdienste, Takeway, Bestellmethoden etc. und einem abschließenden Teil zur Beurteilung Themenbezogener Aussagen in Form von Likert-Items.
...
Grundsätzlich sind die Fragen im Hauptteil sind meist in Paare gruppiert. Es wird zuerst der Zustand vor der Pandemie, dann der jetzige Zustand abgefragt, um eine mögliche Veränderung zu erfassen. In Einzelfällen wird noch nach einer Einschätzung für die Zukunft gefragt.

Die beiden Fragebögen sind hier im PDF-Format: [Kundenfragebogen - PDF](https://github.com/marcfloeter/Digitale-Wirtschaft-DDG-II/blob/main/Material%20-%20Frageb%C3%B6gen/Kundenfragebogen.pdf), [Gastronomenfragebogen - PDF](https://github.com/marcfloeter/Digitale-Wirtschaft-DDG-II/blob/main/Material%20-%20Frageb%C3%B6gen/Gastronomenfragebogen.pdf) und hier in Google Forms: [Kundenfragebogen - Forms](https://docs.google.com/forms/d/1ORCS9y1mNW58IIMgcKyazP_Xx7u0DDZ-B1lTn1cLQnk/edit), [Gastronomenfragebogen - Forms](https://docs.google.com/forms/d/1uaF4_GDq2__eDgVVea8sRiy_BMrc4Eamde4KC8GMxTQ/edit) zu finden.

## Auswertungsmethoden

Zur weiteren Auswertung wurde neben der deskriptiven Auswertung auch eine mehrfache lineare Regression verwendet. Das Ziel der Verwendung dieser Methode ist es, herauszufinden, ob ein Faktor aus dem Bereich "Digitalisierungsschub wegen Coronapandemie" die Nutzungshäufigkeit des Online-Lieferdiensts beeinflusst. Die Nullhypothese dieser Studie lautet, dass alle Faktorenkoeffizienten, welche aus dem Bereich "Digitalisierung seit Coronakrise" stammen, einen Wert von 0 haben. Wenn es nur einen Faktor aus diesem Bereich gibt, dessen  Koeffizientenwert ungleich 0 ist, dann kann darauf geschlossen werden, dass die Nullhypothese verworfen und die Alternativhypothese akzeptiert wird. Die Regressionsanalyse ist eine übliche Methode zur Vorhersage. Sie wird immer dann verwendet, wenn wir einen kausalen Zusammenhang zwischen Variablen haben. Die Häufigkeit der Nutzung von Online-Lieferservice ist die **abhängige Variable** in dieser Methode. Die mehrfache lineare Regression wurde mit **sklearn** in Python durchgeführt. Die Python-Codes finden sich [**hier**](https://github.com/marcfloeter/Digitale-Wirtschaft-DDG-II/tree/main/Material%20-%20Code). [Alternative Links zu Datenauswertung](https://nbviewer.jupyter.org/github/marcfloeter/Digitale-Wirtschaft-DDG-II/blob/main/Material%20-%20Code/Data%20Visualisierungen.ipynb).

# Ergebnisse der Auswertung
## Kundenforschung

### Erfasste Demografische Daten ###
...
Die Hälfte unserer Befragten bestellte seit der Coronapandemie häufiger Essen über das Internet. Mehr als 80% davon bestellen ihr Essen zum Abendessen. Mehr als 40% der Befragten sind nach der Lockerung der Coronamaßnahmen im späten Frühling 2020 wieder häufiger ins Restaurant gegangen anstatt Essen zu bestellen, aber nicht wenige von ihnen bestellen trotzdem ihr Essen per Lieferservice, obwohl sie ins Restaurant gegangen sind. Fast alle Befragten wollen nach der Coronapandemie wieder häufiger ins Restaurant. Allerdings glaubt mehr als die Hälfte von ihnen, dass die Nutzung der Lieferdienste während der Coronapandemie einen dauerhaften Effekt auf das Konsumverhalten im Bereich Gastronomie haben wird. Abgesehen von Liefer- und Takeawaydiensten gibt es auch Kochboxdienste, aber die meisten von Befragten sind immer noch zögerlich, einen solchen Service in Anspruch zu nehmen.
...
Tabelle 2: Wenn der Wert des **variance inflation factor** (VIF) zwischen 1 und 5 liegt, ist die Multikolinearität in Ordnung
...
Der Faktor, der die Nutzung von Lieferservices am meisten beeinflusst, ist der Abschluss einer Berufsausbildung. Zeit und Energie gehen aufgrund der geschäftigen Arbeits- und Lernpläne unweigerlich zur Neige, deshalb  Kochen manchmal nicht mehr möglich ist. Für jemanden, dessen Beschäftigungsstatus selbstständig, Vollzeitangestelt, oder Student/ Schüler ist, bestellt 1,5-mal häufiger Essen über Online-Lieferservices pro Monat. Überraschend ist, dass die Nutzung von Takeaways und Lieferdienst nicht durch die monatlichen Ausgaben für Lebensmittel beeinflusst wird. Dies erklärt die Existenz von Endogenität (ungeklärte Kovarianz) und Heteroskedastizität. Darüber hinaus wirkt sich die Anzahl der Kinder auf die Nutzung von Lieferservices negativ aus. Je mehr Kinder eine Person hat, desto seltener nutzt sie Lieferservices. Eltern bevorzugen es, etwas zu kochen oder Alternativen zu Lieferservices zu nutzen, um Mahlzeiten für ihre Familien zuzubereiten.
...
Tabelle 4: Demografische Angaben der Gastronomen
...
Von den Bezahlmöglichkeiten bieten alle 4 Teilnehmern ihren Kunden alle verfügbaren Möglichkeiten an (Bar, mit Karte, Kontaktlos und per Online/Überweisung). Verglichen mit der Zeit vor Corona ergibt sich hierbei eine Veränderung/Erweiterung mit den Zahlungsmöglichkeiten. Vor der Coronakrise akzeptierten zwar alle 4 Restaurants Barzahlung, aber nur 3 der Restaurants boten die anderen aufgeführten Zahlungsvarianten an.
...
Aus dem Angebot der hauseigenen Lieferdienste ist erkennbar, dass es bei allen Beteiligten zu keiner Veränderung gekommen ist, da alle 4 Restaurants bereits vor der Coronakrise einen hauseigenen Lieferdienst angeboten haben und auch weiterhin einen hauseigenen Lieferdienst anbieten.
...
Bei der verwendeten Bestellmethode hingegen ergeben sich deutliche Unterschiede. Bei Lieferdiensten ist die am häufigsten genutze Bestellmethode die Bestellung per Telefon (Bei allen 4 Restaurants), gefolgt von Restauranteigenen Websiten und Apps (Jeweils 3 Restaurants). Die gar nicht genutzte Option ist die Bestellung über die Website eines großen Online-Lieferdienstes. Keiner der Teilnehmer benutzt diese Option. Anders hingegen sieht es bei Takeaways aus. Hierbei sind die am häufigsten genutzten Methoden die Bestellung vor Ort und per Telefon (jeweils 4 Restaurants), gefolgt von der restauranteigenen Website (3 Restaurants). Dadurch das alle beteiligten Lieferdienste und Takeaways anbieten ergeben sich logischerweise keine Angaben zu den Optionen "Wir bieten keinen Lieferdienst/Takeaways an".


Bei der Frage nach der Nutzung des Cloud-Kitchen Konzeptes ergibt sich eine deutliche Antwort, da alle 4 Beteiligten sich nicht vorstellen können solch ein Konzept zu benutzen.


### Motivation für die Entwicklungen ###

Insgesamt lässt sich bei der Motivation für die Nutzung und das Angebot von Lieferdiensten feststellen, dass Lieferdienste für manche Betreiber durchaus eine Möglichkeit darstellen können mehr Kunden für ihr Geschäft zu gewinnen, dies allerdings nicht zwangsläufig erfolgreicher ist als das anbieten von Takeaway-Services.
Bei der restlichen Motivation ergibt sich eine deutliche Diskrepanz bezüglich des Inputs. 3 der 4 Beteiligten stimmen vielen der gefragten Punkte vollumfänglich zu, während der verbliebene Beteiligte in den meisten Fragen gar nicht übereinstimmt.
...
Hingegen bei Takeaways ergibt sich ein anderes Bild. Alle Beteiligten sind hierbei der Ansicht, dass sich durch Takeawayangebote mehr Kunden gewinnen lassen. Sowohl insgesamt als auch im Vergleich zu Lieferdiensten, auch bedingt dadurch, dass nach Ansicht der beteiligten die Kunden eher Takeaway-Services in Anspruch nehmen. Übereinstimmung ergibt sich auch in der Aussage, dass Takeaway angeboten wird, weil das Produkt nicht vor Ort konsumierbar ist, allerdings stimmt keiner der Beteiligten darin überein, dass sie Takeaway anbieten, weil ihre Produkte nicht vor Ort im Restaurant bestell- oder konsumierbar sind.

# Fazit
Unsere Forschungsfrage lässt sich in beiden Fällen, sowohl bei den Kunden als auch bei den Gastronomen, mit einem **NEIN** beantworten. Die Forschung an diesem Thema lieferte uns trotzdem wichtige und zum Teil unerwartete Daten, Einblicke und Eindrücke über potenzielle Entwicklungen.

Unsere Auswertungen mithilfe der linearen Regression zeigen unter anderem, dass es mit dem Beginn der Coronakrise durchaus zu Veränderungen gekommen ist. Diese erfolgen allerdings in solch einem geringen Umfang, dass deren Auswirkungen nicht als signifikant zu bezeichnen sind.
